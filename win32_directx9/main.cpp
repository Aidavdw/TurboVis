...
int main(int, char**)
{
    ...
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("TurboVis"), NULL };
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindow(wc.lpszClassName, _T("Turbomachine visualisation tool"), WS_OVERLAPPEDWINDOW, 100, 100, 20, 100, NULL, NULL, wc.hInstance, NULL);
